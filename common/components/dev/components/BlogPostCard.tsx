...
// import TwikooCommentCount from "@/common/components/TwikooCommentCount";
import LazyImage from "@/common/components/dev/LazyImage";
...
const BlogPostCard = ({ post }) => {
  ...
  return (
    <article
      className={`${
        showPageCover ? "flex md:flex-row flex-col-reverse" : ""
      } replace mb-12 `}
    >
